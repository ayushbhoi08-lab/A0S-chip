# Ansh-108 Core (S2) P&R -- modular subtractor rns_sub (mod 12289, 2-stage).
...
puts $fh [format "core            = rns_sub ((x-y) mod 12289, branch-free, 2-stage)"]
...
puts "==================================================="
puts [format "  rns_sub: opt_design = %s"            [expr {$OPT_OK ? "applied" : "SKIPPED"}]]
puts [format "  rns_sub: ROUTED FMAX = %.1f MHz"     $fmax]
